...
In this section, we highlight the versatility of our occlusion modeling by demonstrating its unified application to two different problems: associating point tracks with objects and 3D object localization using objects and point tracks. Inputs and outputs required in both the problems and corresponding notation is tabulated in Table~\ref{tab:notations}.
