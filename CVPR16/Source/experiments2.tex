...
In this section, we benchmark our continuous occlusion model for point-to-object association against the baseline method using detection bounding boxes and state-of-the-art methods for motion segmentation \cite{Rao_etal_2010,Brox_Malik_2010}. We then show how the proposed model may be applied for 3D localization in road scenes. For our experiments, we use the KITTI dataset~\cite{geiger2013vision}, which consists of 35 video sequences (10088 frames, 634 object tracks) of road scenes under a variety of driving conditions. 
