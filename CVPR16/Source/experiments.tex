...
\begin{tabular}{lrrrr}
  ...
  & Ours & BBox & BM & RAS\\
  \midrule
  Dyn. and occ. tracks        & \textbf{13.2} & 21.3 & 30.9 & 37.8 \\
  Occluded tracks             & \textbf{15.7} & 19.8 & 39.5 & 29.3 \\
  Dynamic tracks              & \textbf{06.6} & 11.4 & 15.3 & 21.5 \\
  All tracks                  & \textbf{08.6} & 12.6 & 21.9 & 16.4 \\
  \bottomrule
\end{tabular}
