...
\hline
\hline
\multirow{4}{*}{\rotatebox{90}{Output}} & $P^{ij}_{\text{assoc}}$ & Probability of associating point track $j$ with object $O_i$ \\	
...
Transmission probability only indicates if a ray is transmissible to a particular depth, reflection probability indicates which object obstructs the ray at that depth. Thus, a combination of transmission and reflection probabilities is necessary to explain image observations. Lines 260-274 describe this intuition.
