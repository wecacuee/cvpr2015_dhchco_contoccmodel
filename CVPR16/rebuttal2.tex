...
We initialize by fitting a 3D bounding box to detected bounding boxes and estimated ground plane, with 3D size priors. Initialization errors are \textbf{5.61} for t and \textbf{3.23} for dim. They show advantage of our energy minimization and we will add them to Table 2.
