...
We use a total of 35 sequences, 10088 frames, and 634 objects with occlusions of the KITTI dataset. Main parameters are $\lambda_{t}$ = 1, $\lambda_{d}$ = 1, $\lambda_{dyn}$ = 10, $\lambda_{size} = 7$. The final version will include a detailed list of parameters.
