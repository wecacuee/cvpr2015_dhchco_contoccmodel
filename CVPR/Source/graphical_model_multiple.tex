...
\newcommand{\scenegraphicalmodel}{
  \begin{scope}[grow cyclic, line width=1.2,
      ...
      bboxfactor/.style= {rectangle,inner sep=2,draw=green,fill=green,thick,text=green},
      collfactor/.style= {rectangle,inner sep=2,draw=blue,fill=blue,thick,text=blue},
      trackfactor/.style={rectangle,inner sep=2,draw=red,fill=red,thick,text=red},
    ...
    \path[use as bounding box,clip] (-2.6, -5.5) rectangle (6.0,0.5);
